...
const About = () => {
    const aboutData = {
        // Localized Content for Fiasco Consultancy
        subtitle: 'The Fiasco Advantage',
        title: 'Strategic Consulting Tailored for East Africa',
        description: 'Fiasco Consultancy is your trusted partner for navigating the complex East African business landscape. We specialize in market entry, operational excellence, and sustainable growth strategies to ensure your success in the region.',
        count: 15, // Adjusted count for a more realistic consultancy figure
        exp: 'Years of Experience in Regional Consulting',
        btn_title: 'Discover Our Approach',
        btn_link: '/about',
        author_name: 'Shazda Khan', // Example Kenyan name
        author_sub: 'Lead Strategy Consultant',
    }
    return (
