...
const Services = () => {
    // Assuming servicesData holds the 4 key services for Fiasco Consultancy
    const servicesItem = servicesData.slice(0, 4); 
    const servicesContent = {
        // Localized Subtitle
        subtitle: 'OUR REGIONAL EXPERTISE',
        // Localized Title
        title: 'Strategic Consulting for the East African Market',
    ...
    return (
        <div className="services__one section-padding pt-0">
            <div className="container">
                ...
                <div className="row">
                    {/* These items need to be updated in the external services-data.js file */}
