    ...
    return (
        <div className="project__area-page section-padding-two">
            <div className="container">
                <div className="row">
                    {/* Maps over the portfolio items (Case Studies) */}
                ...
                {next < items.length && (
                    <div className="row mt-70">
                        <div className="col-xl-12 t-center">
                            {/* Localized 'Load More' Button Text */}
                            <button onClick={handleLoadData} className="btn-one">View More Success Stories</button>
                        </div>
                    </div>
                )}
            </div>
