                                ...
                                <div className="team__single-left-info-contact">
                                    ...
                                    <div className="team__single-left-info-contact-item mb-45">
                                        ...
                                        <div className="team__single-left-info-contact-item-info">
                                            ...
                                            <h5><Link href="https://www.google.com/maps" target="_blank">Standard Street,Nairobi-Kenya</Link></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>						
                                        ...
                                        <div className="col-md-6 md-mb-30">
                                            <div className="team__single-right-form-select">
                                                <select>
                                                   ...
                                                   <option value="project-turnaround">Failing Project Turnaround</option>
                                                   <option value="reputation-repair">Reputation Repair</option>
                                                   <option value="litigation-support">Fiasco Litigation Support</option>
                                                   <option value="audit-investigation">Internal Audit & Investigation</option>
                                                   <option value="risk-assessment">High-Risk Scenario Assessment</option>
                                            </select>
                                            </div>
                                        </div>
