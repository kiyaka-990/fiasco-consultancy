                    ...
                    <div className="row">
                        <div className="col-xl-5 col-md-6">
                            <div className="top__bar-left">
                                <Link href="https://www.google.com/maps"><i className="far fa-map-marker-alt"></i>Koinange Street. Cianda Hse, Nairobi</Link>
                            </div>
                        </div>
                        <div className="col-xl-7 col-md-6">
                            <div className="top__bar-right">
                                <Link href="mailto:conbix@gmail.com"><i className="fas fa-envelope"></i>info@fiascoconsultancy.co.ke</Link>
