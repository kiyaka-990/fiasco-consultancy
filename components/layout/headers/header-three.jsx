                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-7 col-lg-6">
                            <div className="topbar__three-right t-right lg-t-center">
                                <ul>
                                    <li><a href="tel:(+107)555-0133"><i className="fas fa-phone-alt"></i>+254712770999</a></li>
                                    <li><a href="mailto:conbix@gmail.com"><i className="fas fa-envelope"></i>info@fiascoconsultancy.co.ke</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
